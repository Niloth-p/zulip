...
DISCUSSION_TEMPLATES = {
    ...
    "transferred": "{sender} {action} [discussion #{discussion_number}{optional_title}]({url}) from {repository_name} to **{new_repository_name}** as [discussion #{new_discussion_number}]({url})",
...
def get_discussion_action(payload: WildValue) -> str:
    action = payload["action"].tame(check_string)
    if action in ("unlocked", "pinned", "unpinned", "deleted", "reopened"):
