...
~~~"""
    ...
    def test_discussion_deleted(self) -> None:
        expected_message = "Niloth-p **deleted** [discussion #3](https://github.com/Niloth-p/webhook-tester/discussions/3)."
    ...
    def test_discussion_transferred(self) -> None:
        expected_message = "Niloth-p transferred [discussion #3](https://github.com/Niloth-p/webhook-tester/discussions/3) from webhook-tester to **another-webhook-tester** as [discussion #1](https://github.com/Niloth-p/webhook-tester/discussions/3)"
